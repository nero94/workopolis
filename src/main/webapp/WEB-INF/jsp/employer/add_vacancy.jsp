  ...
  <div id="add-vac-container" class="container">
    <div class="interv-info well col-lg-12">
      ...
      <div class="col-lg-12 intervs well">
        <form:form action="/add_vacancy" method="post" modelAttribute="vacancy">
          <table class="table table-striped table-responsive">
            ...
            <tbody>
              <td><form:input path="title" class="form-control" required="true"/></td>
              ...
              <td><div class="input-group">
                ...
                <form:input path="salary" type="number" class="form-control" required="true"/>
              </div></td>
            </tbody>
          </table>
          <table class="table table-striped table-responsive">
            ...
            <tbody>
              <td><form:textarea path="description" type="text" id="tworows" class="col-lg-12 col-md-12  col-sm-12 col-xs-12" required="true"/></td>
            </tbody>
            <thead>
          ...
          <table class="table table-striped table-responsive" id = "copy-com-skill">
            ...
            <tbody>
              <thead>
                ...
                <th colspan="2"><h4>Select a required level</h4></th>
                <th><h4>Select an importance</h4></th>
              </thead>
              <tbody>
          ...
          <table class="table table-striped table-responsive" id = "copy-pers-skill">
            ...
            <tbody>
              <thead>
                <th colspan="2"><h4>Select a Name of The Skill</h4></th>
                <th><h4>Select a required level</h4></th>
                <th colspan="3"></th>
              </thead>
              <tbody>
