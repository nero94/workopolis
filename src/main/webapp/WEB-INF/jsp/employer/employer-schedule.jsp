...
<div class="container">
  <div class="loc-lg-12">
    <h3 class="col-lg-5 col-lg-offset-1"><span class="col-lg-5" id="interview-example">Interview - </span><div class="interv-exampl well col-lg-5"></div></h3>
    <h3 class="col-lg-5"><span class="col-lg-4" id="offer-example">Offer - </span><div class="offer-exampl well col-lg-5"></h3>
  </div>
</div>
<div class="container">
