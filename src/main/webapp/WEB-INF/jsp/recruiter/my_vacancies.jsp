...
<div class="paginated">
<c:forEach items="${recruiterVacancies}" var="vacancy">

  <article class="search-result row">

     <div class="col-lg-3 col-xs-4 col-sm-4 col-md-4 col-sm-offset-4 col-xs-offset-2 col-md-offset-0 col-lg-offset-0">
     <a href="/vacancy/${vacancy.id}"><img class="company-logo" src="/resources/employer/img/${vacancy.company.imgUrl}" alt="CompanyLogo" /></a>
     </div>
     <div id="vac-text" class="col-lg-5 col-xs-12 col-sm-12 col-md-4 excerpet">
        <h3 class=""><a href="/vacancy/${vacancy.id}"> <c:out value="${vacancy.title}"/></a></h3>
     ...
     <div id="glyphicons" class="col-lg-2 col-xs-4 col-sm-4 col-md-2">
      ...
      <div id="glyphicons" class="col-lg-2 col-xs-4 col-sm-4 col-md-2">
        <input onclick="location.href='/recruiter/find-candidates?id=${vacancy.id}'" type="button" value="Find Candidates" class="btn btn-success col-md-12  col-xs-12 col-sm-12 new-vac-btn">
        <input onclick="location.href='/recruiter/applied_candidates?id=${vacancy.id}'" type="button" name="name" value="Applied Candidates" class="btn btn-success col-md-12  col-xs-12 col-sm-12 new-vac-btn">
        <input onclick="location.href='/vacancyDescription?id=${vacancy.id}'" type="button" name="name" value="Details" class="btn btn-primary col-md-12  col-xs-12 col-sm-12 new-vac-btn">
      </div>
